...
const destinations: Destination[] = [
  ...
  {
    name: "Rani Mahal",
    description: "Rani Mahal, also known as the Taj Mahal of Nepal, is a beautiful palace located on the banks of the Kali Gandaki River in Palpa.",
  ...
  },
  {
    ...
    description: "Boudhanath Stupa is one of the largest stupas in Nepal and an important pilgrimage site for Buddhists.",
  ...
  },
  {
    ...
    imageUrl: "https://fulltimeexplorer.com/wp-content/uploads/2020/05/Bandipur-Nepal-Travel-Guide-4206.jpg",
    category: "historical",
  ...
  },
  {
    ...
    howToReach: "Fly from Kathmandu to Janakpur or take a bus from major cities in Nepal.",
