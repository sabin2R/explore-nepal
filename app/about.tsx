  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.text}>
        Explore Nepal is your ultimate travel companion app for exploring the beautiful landscapes, rich culture, and historical landmarks of Nepal. Whether you're planning a trek to the Everest Base Camp, a visit to the tranquil Rara Lake, or exploring the bustling streets of Kathmandu, Explore Nepal provides you with all the information you need.
      </Text>
      <Text style={styles.text}>
      ...
      <Text style={styles.copyright}>© 2024 Explore Nepal. All rights reserved.</Text>
    </SafeAreaView>
  );
};
